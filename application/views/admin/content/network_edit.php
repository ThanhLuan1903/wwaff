          ...
          <div class="form-group">
            ...
            <div class="well well-lg pbcolleft">
               <div class="row"> 
                    ...
                    <span class="col-sm-2">Pass:</span><span class="col-sm-10"><input style="width: 334px;" title="#pass" value="<?php if($dulieu){echo $dulieu->pb_pass;} ?>" type="text" name="pb_pass" /></span>
                    
                    <span class="col-sm-2">Affsub id:</span>
                    <span class="col-sm-10">
                        <input title="#0" value="<?php if($dulieu){echo $pb_value_array['clickid'][0];} ?>" class="sp50" type="text" name="pb_value[clickid][]" />
                        <span class="right">=</span>                        
                        <input title="#1" value="<?php if($dulieu){echo $pb_value_array['clickid'][1];} ?>" class="sp50" type="text" name="pb_value[clickid][]" />
                    ...
                    <span class="col-sm-10">                                 
                        <input title="#2" value="<?php if($dulieu){echo $pb_value_array['commission'][0];} ?>" class="sp50" type="text" name="pb_value[commission][]" />
                        <span class="right">=</span>
                        <input title="#3" value="<?php if($dulieu){echo $pb_value_array['commission'][1];} ?>" class="sp50" type="text" name="pb_value[commission][]" />
                     </span>
                    
                    <span class="col-sm-2">Offer:  </span>  
                    <span class="col-sm-10">                                
                        <input title="#4" value="<?php if($dulieu){echo $pb_value_array['sale_amount'][0];} ?>" class="sp50" type="text" name="pb_value[sale_amount][]" />
                        <span class="right">=</span>
                        <input title="#5" value="<?php if($dulieu){echo $pb_value_array['sale_amount'][1];} ?>" class="sp50" type="text" name="pb_value[sale_amount][]" />
