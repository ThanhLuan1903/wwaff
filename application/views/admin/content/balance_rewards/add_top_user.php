<div class="row">
  <div class="box col-md-12">
    ...
    <div class="box-content">
      <!--- noi dung--->
      <form class="form-horizontal" method="POST" action="<?php echo base_url() . $this->config->item('admin') . '/custom_balance_rewards/custom_user/' . $user->id ?>">
        <input hidden name="reward" value="1" />
        ...
        <div class="form-group">
          <div class="col-sm-offset-2 col-sm-10">
            <button type="submit" value="2" name="type" class="btn btn-default">Submit</button>
          </div>
        </div>
      </form>
      <!--noi dung --->
