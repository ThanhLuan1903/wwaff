                        ...
                        if (!empty($dulieu)) {
                            foreach ($dulieu as $dulieu) { ?>
                             <tr>
                                 ...
                                 <td class="view span30"><a href="<?php echo base_url() . $this->config->item('admin') . '/route/' . $this->uri->segment(3) . '/edit/' . $dulieu->id; ?>">edit</a></td>
                                 <td class="del span30"><a href="<?php echo base_url() . $this->config->item('admin') . '/route/' . $this->uri->segment(3) . '/delete/' . $dulieu->id; ?>">del</a></td>
