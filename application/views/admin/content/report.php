                    ...
                    <form class="form-inline" method="post" role="form">
                        ...
                        <div class="col-md-12" style=" display: flex; flex-wrap: nowrap; padding:0">
                            <span class="form-group col-md-2 inputrepr">
                                ...
                                <input id="startdate" type="text" name="from" value="<?php if ($this->session->userdata('from')) {
                            ...
                            <span class="form-group col-md-2 inputrepr">
                                ...
                                <input id="enddate" type="text" name="to" value="<?php if ($this->session->userdata('to')) {
                            ...
                            <span class="form-group col-md-2">
                                ...
                                <select class="form-control input-sm" name="idnet">
                                    ...
                                    foreach ($net as $net) {
                                        ...
                                        echo "<option $selected value='$net->id'> $net->title </option>";
                                    }
                                    ?>
                                </select>
                            </span>
