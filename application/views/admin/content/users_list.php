...
<div class="row">
    ...
    <div class="box col-md-12">
        <div data-original-title="" class="box-header">
            ...
            <div class="box-icon">
                <a class="btn-add" href="<?php echo base_url() . $this->config->item('admin') . '/addusers/'; ?>"><i
                        ...
                        <div class="checkbox-filters">
                            <label class="checkbox-inline">
                                <input type="checkbox" name="balance" value="1"
                                    <?= !empty($where['balance >']) ? 'checked' : '' ?>> Balance
                            </label>
                            <label class="checkbox-inline">
                                <input type="checkbox" name="pending" value="1"
                                    <?= !empty($where['pending >']) ? 'checked' : '' ?>> Pending
                            </label>
                            <label class="checkbox-inline">
                                <input type="checkbox" name="curent" value="1"
                                    <?= !empty($where['curent >']) ? 'checked' : '' ?>> Current
                            </label>
                        </div>
                    ...
                    <div class="sorting-filters">
                        ...
                        <div class="filter-group">
                            ...
                            <select class="form-control input-sm sorting" name="level">
                                <option value="">--</option>
                                <option value="desc" <?= $sort == 'level' && $order == 'desc' ? 'selected' : '' ?>>
                                    High-Low</option>
                                <option value="asc" <?= $sort == 'level' && $order == 'asc' ? 'selected' : '' ?>>
                                    Low-High</option>
                            </select>
                        </div>
                        ...
                        <div class="filter-group">
                            ...
                            <select class="form-control input-sm sorting" name="epc">
                                <option value="">--</option>
                                <option value="desc" <?= $sort == 'epc' && $order == 'desc' ? 'selected' : '' ?>>
                                    High-Low</option>
                                <option value="asc" <?= $sort == 'epc' && $order == 'asc' ? 'selected' : '' ?>>Low-High
                                </option>
                            </select>
                        </div>
                        ...
                        <div class="filter-group">
                            ...
                            <select class="form-control input-sm sorting" name="conversion_rate">
                                <option value="">--</option>
                                <option value="desc"
                                    <?= $sort == 'conversion_rate' && $order == 'desc' ? 'selected' : '' ?>>High-Low
                                </option>
                                <option value="asc"
                                    <?= $sort == 'conversion_rate' && $order == 'asc' ? 'selected' : '' ?>>Low-High
                                </option>
                            </select>
                        </div>
                        ...
                        <div class="filter-group">
                            ...
                            <select class="form-control input-sm sorting" name="rating">
                                <option value="">--</option>
                                <option value="desc" <?= $sort == 'rating' && $order == 'desc' ? 'selected' : '' ?>>
                                    High-Low</option>
                                <option value="asc" <?= $sort == 'rating' && $order == 'asc' ? 'selected' : '' ?>>
                                    Low-High</option>
                            </select>
                        </div>
                        ...
                        <div class="filter-group">
                            ...
                            <select class="form-control input-sm sorting" name="decline_rate">
                                <option value="">--</option>
                                <option value="desc"
                                    <?= $sort == 'decline_rate' && $order == 'desc' ? 'selected' : '' ?>>High-Low
                                </option>
                                <option value="asc" <?= $sort == 'decline_rate' && $order == 'asc' ? 'selected' : '' ?>>
                                    Low-High</option>
                            </select>
                        </div>
                    </div>
                ...
                <table class="table table-striped table-bordered table-fix-overflow">
                    <thead>
                        <tr role="row">
                            ...
                            <th style="min-width: 200px">Skype</th>
                            ...
                            <th style="min-width: 60px">Rating</th>
                            <th style="min-width: 60px">EPC</th>
                            <th style="min-width: 60px">CR</th>
                            <th style="min-width: 60px">DisLead(%)</th>
                            <th style="min-width: 100px;">Status</th>
                            <th style="min-width: 110px">Verification state</th>
                    ...
                    ?>
                        <tr>
                            ...
                            <td class="approv">
                                ...
                                <select id="<?php echo $dulieu->id; ?>" class="sapproved update-user-status"
                                    style="display: none;">
                                    <option value="0">Pending</option>
                                    <option value="1" <?php echo $dulieu->status == 1 ? 'selected' : ''; ?>>Approved
                                    </option>
                                    <option value="2" <?php echo $dulieu->status == 2 ? 'selected' : ''; ?>>Pause
                                    </option>
                                    <option value="3" <?php echo $dulieu->status == 3 ? 'selected' : ''; ?>>Banned
                                    </option>
                                    <option value="4" <?php echo $dulieu->status == 4 ? 'selected' : ''; ?>>Reject
                                    </option>
                                </select>
                            </td>
                            <td>
                                <?php
                                        if($dulieu->activated == 1){
                                            ...
                                            echo '<span style="color: orange;">Unconfirmed</span>';
                                        }
                                        ?>
                            </td>
                            ...
                            <td>
                                <a data-email="<?php echo $dulieu->email; ?>" title="<?php echo $dulieu->id; ?>"
                                    class="btn btn-success btn-xs invoice">
                                    <i class="glyphicon glyphicon-euro glyphicon-white"></i>
                                </a>
                                <a href="<?php echo base_url() . $this->config->item('admin') . '/viewmember/publisher/' . $dulieu->id; ?>"
                                    class="btn btn-success btn-xs" target=_blank>
                                    <i class="glyphicon glyphicon-eye-open glyphicon-white"></i>
                                </a>
                                <a href="<?php echo base_url() . $this->config->item('admin') . '/showev/tracklink/' . $dulieu->id; ?>"
                                ...
                                <a href="<?php echo base_url() . 'cron-jobs/calculator/publishers/' . $dulieu->id; ?>"
