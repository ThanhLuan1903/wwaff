        ...
        <form class="form-horizontal" method="POST" action="<?php echo base_url().$this->config->item('admin').'/route/'.$this->uri->segment(3).'/'.$this->uri->segment(4);?>">
         ...
         <?php if($dulieu){echo '<input class="hide" value="'.$dulieu->id.'" name="id"/>';} ?>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" class="form-control" id="offerid" name="offerid" value="<?php if($dulieu){echo $dulieu->offerid;} ?>" placeholder="offerid"/>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" class="form-control" id="title" name="userid" value="<?php if($dulieu){echo $dulieu->userid;} ?>" placeholder="userid"/>
            </div>
          </div>  
