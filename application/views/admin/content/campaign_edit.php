    ...
    <div class="box-content">
      ...
      <form class="form-horizontal" method="POST" action="<?php echo base_url() . $this->config->item('admin') . '/route/' . $this->uri->segment(3) . '/' . $this->uri->segment(4); ?>">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <input type="text" class="form-control" id="title" name="Campaign" value="<?php if ($dulieu) {
                                                                                        echo $dulieu->campaign;
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <input type="text" class="form-control" id="url_success" name="url_success" value="<?php if ($dulieu) {
                                                                                                  echo $dulieu->url_success;
                                                                                                } ?>" placeholder="Url Success" />
          </div>
        </div>
