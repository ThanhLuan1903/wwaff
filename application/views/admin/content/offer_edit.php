...
<link href="<?php echo base_url('temp/admin/css/offer-edit.css') . '?v=' . time(); ?>" rel="stylesheet">
                  ...
                  <div class="form-group" id="cr_options_container" style="margin-top:20px;display:none">
                     <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                           ...
                           <!-- Option 1: 3% - 15% (5 conversions threshold) -->
                           <div class="form-group">
                              <div class="radio">
                                 <label class="control-label" style="font-weight: normal;">
                           ...
                           <!-- Option 2: 2% - 30% (10 conversions threshold) -->
                           <div class="form-group">
                              <div class="radio">
                                 <label class="control-label" style="font-weight: normal;">
                        ...
                        <div class="panel panel-default">
                           <div class="panel-body">
                              ...
                              <div class="catscroll geocontent d-flex">
                                 ...
                                 echo '<input name="percent_geos[all]" type="text" class="form-control input-sm amount point_ct"
                                       value="' . $pp . '"
                                       placeholder="%" />
                                       </p>
                                       ';
                                 ...
                                 if (!empty($country)) {
                                    foreach ($country as $country) {
                                       ...
                                       echo '<input name="percent_geos[' . $country->keycode . ']" type="text" class="form-control input-sm amount point_ct"
                                               value ="' . $pp . '"
                                               placeholder="%"/>
                                               </p>
                                               ';
...
<script>
   ...
   var capUrl = '<?php echo base_url(); ?>admin/exceptionHandler/show_capModal';
   var savecapPub = '<?php echo base_url(); ?>admin/exceptionHandler/save_cappub';
   var delete_exccap = '<?php echo base_url(); ?>admin/exceptionHandler/delete_exccap';

   var modalUrl = '<?php echo base_url(); ?>admin/exceptionHandler/show_modal';
   var save_exce = '<?php echo base_url(); ?>admin/exceptionHandler/save_exce';
   var delete_exc = '<?php echo base_url(); ?>admin/exceptionHandler/delete_exc';
</script>
<script src="<?php echo base_url('temp/admin/js/offer_edit.js'); ?>?v=<?php echo rand(1000, 9999); ?>"></script>