...
<div class="row">
    <div class="box col-md-12">
        ...
        <div class="box-content">
            <div class="row">
                <div class="col-md-12">
                    <form class="form-inline" method="post" action="<?php echo base_url('adm_adc/dashboard/search'); ?>" role="form">
