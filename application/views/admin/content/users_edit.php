 ...
 <?php $conversion_flow = [];
   foreach ($mailling['conversion_flow'] as $offer_type) {
      array_push($conversion_flow, $this->Admin_model->get_data('offertype', ['id' => $offertype]));
   }
 ...
 <table class="tb_content clearfix">
    ...
    <tr>
       ...
       <td>
          <form action="<?php echo base_url() . $this->config->item('admin') . '/editpass/' . $dulieu->id; ?>" method="POST">
    ...
    <tr>
       ...
       <td><?php echo $mailling['phone']; ?></td>
    </tr>
    <tr>
       <td class="dd">Conversion Flow</td>
       <td><?php echo $mailling['conversion_flow']; ?></td>
    </tr>
    <tr>
       <td class="dd">Volume </td>
       <td><?php echo $mailling['volume']; ?></td>
    </tr>
    <tr>
       <td class="dd">Traffic Device</td>
       <td><?php echo $mailling['traffic_device']; ?></td>
    </tr>
