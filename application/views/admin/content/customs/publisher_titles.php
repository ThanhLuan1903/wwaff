...
<section>
  <div class="box-header">
    ...
    <div class="box-icon">
      <a class="btn-add" href="<?php echo base_url() . $this->config->item('admin') . '/custom/edit_publisher_title' ?>"><i class="glyphicon glyphicon-plus"></i></a>
      ...
      <form>
        ...
        <?php foreach ($titles as $title) : ?>
          <tr>
            ...
            <td>
              <!--edit>>>-->
              <a href="<?php echo base_url() . $this->config->item('admin') . '/custom/edit_publisher_title/' . $title->type; ?>" class="btn btn-info btn-xs">
