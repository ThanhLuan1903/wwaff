    ...
    <div class="box col-md-12">
        <div class="box-header">
            ...
            <div class="box-icon">
                ...
                <a class="btn-close" href="<?php echo base_url() . $this->config->item('admin') . '/route/' . $this->uri->segment(3); ?>"><i class="glyphicon glyphicon-remove"></i></a>
            </div>
        </div>
                ...
                <form>
                    ...
                    <?php foreach ($dulieu as $banner): ?>
                        <tr>
                            ...
                            <td>
                                <!--edit>>>-->
                                <a href="<?php echo base_url() . $this->config->item('admin') . '/route/' . $this->uri->segment(3) . '/edit/' . $banner->id; ?>" class="btn btn-info btn-xs">
                                    <i class="glyphicon glyphicon-edit glyphicon glyphicon-white"></i>
                                </a>
                                <!--delete>>>-->
                                <a href="<?php echo base_url() . $this->config->item('admin') . '/route/' . $this->uri->segment(3) . '/delete/' . $banner->id; ?>" class="btn btn-danger btn-xs">
