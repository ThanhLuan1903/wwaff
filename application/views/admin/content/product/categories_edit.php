  ...
  <div class="box col-md-12">
    ...
    <div class="box-content">
      <form class="form-horizontal" method="POST" action="<?php echo base_url() . $this->config->item('admin') . '/product/' . $this->uri->segment(3); ?>">
        ...
        <?php if ($data) {
          echo '<input class="hide" value="' . $data->id . '" name="id"/>';
        } ?>

        <div class="form-group">
          <label class="col-sm-2 control-label">Category Title</label>
          <div class="col-sm-10">
            <input type="text" class="form-control" id="title" name="title" value="<?php if ($data) {
                                                                                      echo $data->title;
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <span class="box_switch<?php if ($data) {
                                      echo $data->status == 1 ? '' : ' off';
                                    } ?>">
              <a href="">switch off</a>
