...
<div class="row">
    <div class="box col-md-12">
        <div class="box-header">
            ...
            <div class="box-icon">
                <a href="<?= base_url('admin/dashboard/show/all') ?>" title="Back to Table">
        ...
        <div class="box-content">
            ...
            <div class="col-md-12" style="margin-bottom: 15px;">
                <div class="btn-group" role="group">
                    <a href="<?= base_url('admin/dashboard/show/all') ?>" class="btn btn-sm btn-default">
                        <i class="glyphicon glyphicon-list"></i> Table View
                    </a>
                    <a href="<?= base_url('admin/dashboard/charts') ?>" class="btn btn-sm btn-primary">
