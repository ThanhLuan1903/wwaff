...
<body>
    ...
    <header class="mb-3 border-bottom navbar-dark fixed-top topmenu">
        <div class="container-fluid">
            <div class="d-flex align-items-center justify-content-between">
                <button type="button" class="button_mb_nav-d d-none" data-bs-toggle="collapse"
                    data-bs-target="#anhienmenu">
                ...
                <?php
                    $receiver = $this->session->userdata('role') == 2 ? $this->session->userdata('user')->id : $this->member->id;
                    if ($receiver) {
                        $where = "receiver = {$receiver} AND is_adv = 0 AND mark_as_read = 0";
                    ...
                    <div class="dropdown  m-auto col-3 mx-3 d-flex d-row">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownUser1"
                            ...
                            <li><a style="font-size:12px" class="dropdown-item"
                                    href="<?php echo base_url('v2/profile/profile'); ?>">Profile</a></li>
                            <li><a style="font-size:12px" class="dropdown-item"
                                    href="<?php echo base_url('v2/request_products'); ?>">Request a product</a></li>
                            ...
                            <li><a style="font-size:12px" class="dropdown-item"
                                    href="<?php echo base_url('v2/logout'); ?>">Sign out</a></li>
    ...
    <!-- modal reference -->
    <div class="modal fade" id="modalRefer" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="input-group mb-3">
                        <input type="text" class="form-control" readonly="true" id="refer"
                            value="<?php echo base_url($this->uri->segment(1) . '/sign/up?ref=' . $this->member->ref_pub_token) ?>">
