    ...
    <div class="box-content">
      <form class="form-horizontal" method="POST" action="<?php echo base_url() . $this->config->item('manager') . '/route/' . $this->uri->segment(3) . '/' . $this->uri->segment(4); ?>">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <input type="text" class="form-control" id="title" name="offerid" value="<?php if ($dulieu) {
                                                                                        echo $dulieu->offerid;
                                                                                      } ?>" placeholder="OfferId" />
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <input type="text" class="form-control" id="usersid" name="usersid" value="<?php if ($dulieu) {
                                                                                          echo $dulieu->usersid;
                                                                                        } ?>" placeholder="UsersID" />
          </div>
        </div>
