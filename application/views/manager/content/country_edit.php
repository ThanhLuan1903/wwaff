    ...
    <div class="box-content">
      ...
      <form class="form-horizontal" method="POST" action="<?php echo base_url() . $this->config->item('manager') . '/route/' . $this->uri->segment(3) . '/' . $this->uri->segment(4); ?>">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <input type="text" class="form-control" id="title" name="country" value="<?php if ($dulieu) {
                                                                                        echo $dulieu->country;
                                                                                      } ?>" placeholder="Country" />
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <input type="text" class="form-control" id="keycode" name="keycode" value="<?php if ($dulieu) {
                                                                                          echo $dulieu->keycode;
