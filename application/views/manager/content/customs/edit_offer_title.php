<div class="row">
  <div class="box col-md-12">
    ...
    <div class="box-content">
      <form class="form-horizontal" method="POST" action="<?php echo base_url() . $this->config->item('manager') . '/custom/edit_title_offer/' . $title->id ?>">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <select name="type" class="form-control input-sm">
              <option value="title-banner-left" <?= $title->type == 'title-banner-left' ? 'selected' : '' ?>>Left</option>
              <option value="title-banner-right" <?= $title->type == 'title-banner-right' ? 'selected' : '' ?>>Right</option>
            </select>
          </div>
        </div>
