...
<section>
  <div class="box-header">
    ...
    <div class="box-icon">
      <a class="btn-add" href="<?php echo base_url() . $this->config->item('manager') . '/custom/edit_title_offer' ?>"><i class="glyphicon glyphicon-plus"></i></a>
      ...
      <form>
        ...
        <?php foreach ($titleBanners as $title) : ?>
          <tr>
            ...
            <td>
              <!--edit>>>-->
              <a href="<?php echo base_url() . $this->config->item('manager') . '/custom/edit_title_offer/' . $title->type; ?>" class="btn btn-info btn-xs">
