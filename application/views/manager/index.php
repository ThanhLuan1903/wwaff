...
<body>
      ...
      <div class="container-fluid">
         ...
         <div class="collapse navbar-collapse" id="anhien">
            <ul class="nav navbar-nav navbar-right">
               ...
               <li class="parentli"><a href="#" class="dropdown-toggle" data-toggle="dropdown"><span class="glyphicon glyphicon-user"></span></a></li>
         ...
         <div style="margin-top: 40px;" class="modal fade userview" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg">
               <div class="modal-content">
                  ...
                  <div class="modal-body cusermodal"></div>
               </div>
            </div>
         </div>
      </div>
   ...
   if ($this->uri->segment(3) == 'network') {
      echo '<script type="text/javascript" src="' . base_url() . 'temp/admin/js/network_edit.js"></script>';
   }
   ?>
   <script type="text/javascript" src="<?php echo base_url(); ?>temp/manager/js/custom.js?v=<?php echo time(); ?>"></script>
   </script>
</body>
