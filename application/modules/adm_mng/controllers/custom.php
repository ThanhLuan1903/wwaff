<?php
require_once(APPPATH . '/modules/adm_mng/services/ServiceProvider.php');
require_once(APPPATH . '/modules/adm_mng/services/classes/ThemeService.php');
...
class Custom extends CI_Controller
{
  ...
  public function view()
  {
    ...
    $content = $this->load->view('manager/content/customs/view', $data, true);
    return $this->load->view('manager/index', compact('content'));
  }

  public function edit($type)
  {
    $data = $this->Custom_model->find_by_type($type);
    $content = $this->load->view('manager/content/customs/form', ['titleBanner' => $data], true);
    return $this->load->view('manager/index', compact('content'));
  }
  ...
  public function edit_register_page($id = null)
  {
    ...
    $content = $this->load->view('manager/content/customs/form_traffic_type', ['traffic_type' => $data], true);
    return $this->load->view('manager/index', compact('content'));
  }
  ...
  public function update($service)
  {
    ...
    if ($this->uri->segment(4) == 'custom-rewards')
      return redirect('manager/custom_sale_rewards/view');
    return redirect('manager/custom/view');
  }
  ...
  public function offer_titles()
  {
    ...
    $content = $this->load->view('manager/content/customs/offer_titles', ['titleBanners' => $offer_titles], true);
    return $this->load->view('manager/index', compact('content'));
  }
  ...
  public function edit_title_offer($type = null)
  {
    ...
    if ($is_post_method) {
      ...
      return redirect(base_url('manager/custom/offer_titles'));
    }

    $content = $this->load->view('manager/content/customs/edit_offer_title', ['title' => $tittle], true);
    return $this->load->view('manager/index', compact('content'));
  }
  ...
  public function publisher_titles()
  {
    ...
    $content = $this->load->view('manager/content/customs/publisher_titles', ['titles' => $titles], true);
    return $this->load->view('manager/index', compact('content'));
  }
  ...
  public function edit_publisher_title($type = null)
  {
    ...
    if ($is_post_method) {
      ...
      return redirect(base_url('manager/custom/publisher_titles'));
    }

    $content = $this->load->view('manager/content/customs/edit_publisher_title', ['title' => $tittle], true);
    return $this->load->view('manager/index', compact('content'));
  }
  ...
  public function publisher_banners()
  {
    ...
    $content = $this->load->view('manager/content/customs/publisher_banners', ['banners' => $banners], true);
    return $this->load->view('manager/index', compact('content'));
  }
  ...
  public function edit_publisher_banner($id = null)
  {
    ...
    if ($is_post_method) {
      ...
      return redirect(base_url('manager/custom/publisher_banners'));
    }

    $content = $this->load->view('manager/content/customs/edit_publisher_banner', ['banner' => $banner], true);
    return $this->load->view('manager/index', compact('content'));
  }
}
