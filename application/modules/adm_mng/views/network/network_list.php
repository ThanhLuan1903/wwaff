                ...
                <?php if (!empty($dulieu)) {
                    foreach ($dulieu as $dulieu) { ?>
                        <tr>
                            ...
                            <td>
                                <a href="<?php echo base_url() . $this->config->item('manager') . '/' . $this->uri->segment(2) . '/edit/' . $dulieu->id; ?>"
                                    class="btn btn-info btn-xs">
                                    <i class="glyphicon glyphicon-edit glyphicon glyphicon-white"></i>
                                </a>
                                <a href="<?php echo base_url() . $this->config->item('manager') . '/' . $this->uri->segment(2) . '/delete/' . $dulieu->id; ?>"
