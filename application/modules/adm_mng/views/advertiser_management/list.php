...
<div class="row">
    <div class="draw-back">
        <img src="<?php echo base_url(); ?>temp/manager/images/loading.gif" alt="" height="100px" width="100px"> Loading...
    </div>
    <div class="box col-md-12">
        ...
        <div class="box-header">
            ...
            <div class="box-icon">
                <a class="btn-add" href="<?php echo base_url() . $this->config->item('manager') . '/advertiser/add_new_advertiser/'; ?>"><i class="glyphicon glyphicon-plus"></i></a>
                    ...
                    <?php } else { ?>
                        ...
                        ?>
                            <tr>
                                ...
                                <td><?= $dt->pending ?></td>
                                <td><?= (isset($dt->available) ? $dt->available : 0) - (isset($dt->invoice) ? $dt->invoice : 0) ?></td>
                                <td class="manager">
                                ...
                                <td>
                                    ...
                                    <!--login acc membert>>>-->
                                    <a href="<?php echo base_url() . $this->config->item('manager') . '/viewmember/advertiser/' . $dt->id; ?>" class="btn btn-success btn-xs" target=_blank>
                                    ...
                                    <!--delete>>>-->
                                    <a href="<?php echo base_url() . $this->config->item('manager') . '/route/' . $this->uri->segment(2) . '/delete/' . $dt->id; ?>" class="btn btn-danger btn-xs del">
