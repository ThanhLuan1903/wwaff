<style>
  ...
  .Approved { background: #aeddae; }
  .Pending { background: #ffffd1; }
  .Deny { background: #f4c9c9; }
  .enditem { border-right: 0px !important; }
  ...
  .smlinks:hover { border-color: #56bf85; }
  .smlinks a { padding: 0 !important; }
  ...
  .show-detail:hover { cursor: pointer; }

  .order_wrap_list_items { width: 100%; }

  .custom-modal { margin: 0 !important; }
  ...
  .Active, .Approve { background: green; }
  .Reject { background: red; }
  .Pending, .Pause { background: orange; }
</style>

<div class="full-width">
  <div class="left-banners sticky-banners">
    <h6 class="text-center" style="margin-bottom:0px"><?= isset($left_title->content) ? substr($left_title->content, 0, 3) : '' ?></h6>
  ...
  <div class="right-banners sticky-banners">
    <h6 class="text-center" style="margin-bottom:0px"><?= isset($right_title->content) ? substr($right_title->content, 0, 3) : '' ?></h6>
    <h6 class="text-center"><?= isset($right_title->content) ? substr($right_title->content, 4) : '' ?></h6>
    <div class="row" style="margin-top:20px">
...
<script>
  ...
  function showToast(type, content) {
    ...
    const body = $('#toast .toast-body');

    header.removeClass('bg-danger bg-success');
    body.removeClass('bg-danger bg-success');
