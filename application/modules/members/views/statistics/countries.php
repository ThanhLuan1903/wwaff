   ...
   <div class="_12e1_3IHEVbMTMaTUzZ7r9">
      <table role="table">
         <thead>
            ...
            <tr role="row">
               <th colspan="1" role="columnheader" title="Toggle SortBy" style="cursor: pointer;">Country<span></span></th>
            ...
            if($data){            
               foreach( $data as $data){
                  ...
                  echo '
                     <tr role="row" class="">
                        <td role="cell">
                           <span class="_1zXei-ymiJr9KAeJboeM6O _1YEl4yCJEz0C3EFWAe9CjL">
                              <img styleprops="[object Object]" src="https://cdnjs.cloudflare.com/ajax/libs/flag-icon-css/3.4.3/flags/4x3/'.strtolower($data->countries).'.svg" style="display: inline-block; width: 1em; height: 1em; vertical-align: middle;">
                              <span class="_1WOmcSS9N_e3KUkqfV0NI">
                              '.$data->countries.'
                              </span>
                           </span>
                        </td>
