<div class="_2JyLbpIPgPwI6RhYP28lbl mb-5">
   <div class="_12e1_3IHEVbMTMaTUzZ7r9">
         ...
         <tbody role="rowgroup">
            <?php foreach ($data as $data) : ?>
               ...
               <tr role="row">
                  ...
                  <td role="cell"><span class="_1zXei-ymiJr9KAeJboeM6O _2qzGcj9CQQHZm8SCJRN_wI"><span><?= $data->traffic_source ?></span></span></td>
                  ...
                  <td role="cell"><span class="_1zXei-ymiJr9KAeJboeM6O _2qzGcj9CQQHZm8SCJRN_wI"><span><?php echo in_array($data->status, [1, 4]) ? adv_status_convert($data->paymterm_calc, $data->date, $data->hold_period, 'pay-' . $data->id) : (in_array($data->status, [3]) ? '<h6><span class="badge bg-info">Paid</span></h6>' : '') ?> </span></span></td>
               </tr>
      ...
      <!-- Thêm phân trang -->
      <div class="pagination-info" style="margin: 15px 0; color: #666;">
