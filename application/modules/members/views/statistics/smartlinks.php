...
<div class="_2JyLbpIPgPwI6RhYP28lbl">
   <div class="_12e1_3IHEVbMTMaTUzZ7r9">
      <table role="table">
         <thead>
            <tr role="row">
               <th colspan="2" role="columnheader">&nbsp;<span></span></th>
            ...
            <tr role="row">
               ...
               <th colspan="1" role="columnheader" title="Toggle SortBy" style="cursor: pointer;">Smartlinks<span></span></th>
         ...
         <tbody role="rowgroup">
         <?php 
         $thosts = $tclick = $tlead =$tdec= $treve=0;
         if($data){            
            foreach( $data as $data){
               ...
               echo '
                  <tr role="row" class="">
                     <td role="cell"><span class="_1zXei-ymiJr9KAeJboeM6O _1YEl4yCJEz0C3EFWAe9CjL"><span>'.$data->smartlink.'</span></span></td>
