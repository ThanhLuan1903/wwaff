   ...
   <div class="_12e1_3IHEVbMTMaTUzZ7r9">
      <table role="table">
         <thead>
            ...
            <tr role="row">
               <th colspan="1" role="columnheader" title="Toggle SortBy" style="cursor: pointer;textTransform:uppercase"><?php echo $this->uri->segment(3) ?><span></span></th>
         ...
         <?php 
            ...
            if($data){            
               foreach( $data as $data){
                  ...
                  echo '
                     <tr role="row" class="">
                        <td role="cell"><span class="_1zXei-ymiJr9KAeJboeM6O _1YEl4yCJEz0C3EFWAe9CjL"><span>'.$data->$sub.'</span></span></td>               
