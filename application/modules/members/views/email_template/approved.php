...
<head>
    ...
    <title>Worldwide Affiliate - Approved</title>
    <style>
    * {
        margin: 0;
        padding: 0;
    ...
    <div class="background">
        <div class="email-container">
            ...
            <div class="content">
                ...
                <p>🎉 We are pleased to inform you that your account has been approved following our review. You can now
                    log in to your dashboard and start promoting our offers.</p>

                <a href="<?php echo $login_link; ?>" class="btn-wwaff" style="
                    color:#000 !important;
                    text-decoration:none !important;
                    display:block;
                ">Login now</a>

                <p>Username: <strong><?php echo $email;?></strong></p>
                <p>Password: <strong>Your password setting</strong></p>
