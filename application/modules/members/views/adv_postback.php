                ...
                <table class="table table-striped table-bordered">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                Click/View identifier/reference specified by the Publisher. <span
                                    class="text-warning">(use to get wwaff's clickid)</span>
                            </td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                Commission amount awarded for the transaction <span class="text-warning"> (Use to get
                                    product's sale amount)</span>
                            </td>
                        </tr>
                        <tr>
                            <td>
