<form class="needs-validation" id="form" novalidate method="POST" enctype="multipart/form-data" action="<?php echo base_url($this->uri->segment(1) . '/advertiser/update_request_product/' . $product_request->id); ?>">
  <div class="mb-2">
  ...
  <div class="mb-2">
    ...
    <input class="form-control" id="input2" name="preview_link" type="text" maxlength="255" required>
