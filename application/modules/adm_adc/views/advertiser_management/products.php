            ...
            <div class="filter-box">
                <div class="row">
                    <div class="col-md-3">
                        ...
                        <select class="form-control select2" name="offercats[]" multiple="multiple">
                            ...
                            <option value="<?= $cat->id ?>"
                                <?= !empty($filter['offercats']) && is_array($filter['offercats']) && in_array($cat->id, $filter['offercats']) ? 'selected' : '' ?>>
                                <?= $cat->offercat ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                    ...
                    <div class="col-md-3">
                        ...
                        <select class="form-control select2" name="network[]" multiple="multiple">
                            ...
                            <option value="<?= $net->id ?>"
                                <?= !empty($filter['network']) && is_array($filter['network']) && in_array($net->id, $filter['network']) ? 'selected' : '' ?>>
                                <?= $net->title ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-12 btn-group-filter text-center">
                        ...
                        <button type="button" class="btn btn-default btn-reset"><i class="fa fa-refresh"></i>
                            Reset</button>
                    </div>
                </div>
            </div>
              ...
              ?>
                            ...
                            <select id="<?php echo $product->id; ?>" class="update-status" style="display: none;">
                                ...
                                <option value="Approve"
                                    <?php echo $product->product_status == 'Approve' ? 'selected' : ''; ?>>Approved
                                </option>
                                <option value="Pause"
                                    <?php echo $product->product_status == 'Pause' ? 'selected' : ''; ?>>Pause</option>
                                <option value="Reject"
                                    <?php echo $product->product_status == 'Reject' ? 'selected' : ''; ?>>Reject
                                </option>
                            </select>
                        </td>
                        <td class="aaction">
                            <a href="<?php echo base_url() . $this->config->item('admin') . '/route/offer/edit/' . $product->id; ?>"
                            ...
                            <a href="<?php echo base_url() . $this->config->item('admin') . '/coppy_offer/' . $product->id; ?>"
                            ...
                            <a href="<?php echo base_url() . $this->config->item('admin') . '/route/offer/delete/' . $product->id; ?>"
