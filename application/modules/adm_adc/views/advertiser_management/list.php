...
<div class="row">
    ...
    <div class="box col-md-12">
        ...
        <div class="box-header">
            ...
            <div class="box-icon">
                <a class="btn-add"
                    href="<?php echo base_url() . $this->config->item('admin') . '/advertiser/add_new_advertiser/'; ?>"><i
        ...
        <div class="box-content">
            ...
            <div class="table-responsive table-scroll-x">
                <table class="table table-striped table-bordered table-center table-fix-overflow">
                    <thead>
                        <tr role="row">
                            ...
                            <th scope="col" style="min-width: 100px">Last Update</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <!--login acc membert>>>-->
                                <a href="<?php echo base_url() . $this->config->item('admin') . '/viewmember/advertiser/' . $dt->id; ?>"
                                ...
                                <!--delete>>>-->
                                <a href="<?php echo base_url() . $this->config->item('admin') . '/route/' . $this->uri->segment(2) . '/delete/' . $dt->id; ?>"
