        ...
        <div class="box-content">
                    ...
                    <?php } else { ?>
                        ...
                        ?>
                            <tr>
                                ...
                                <td><img src="<?php echo $dt->image_url; ?>" class="img-thumbnail product-img" alt=""></td>
                                <td><?php echo $dt->name; ?></td>
                                <td><a href="<?php echo $dt->preview_link ?>" target="_blank"><?php echo $dt->preview_link ?></a></td>
                                ...
                                <td>
                                    ...
                                    <a href="<?= base_url($this->config->item('admin') . '/advertiser/delete_request_product/') . '/' . $dt->id ?>">
                                        <button data-id="<?= $dt->id ?>" class="btn btn-danger btn-xs">
            ...
            <?php if (!empty($data)) { ?>
                <div class="row flex-justify-center">
                    <div class="col-md-6"><?php echo 'Showing ' . $from . ' to ' . $to . ' of ' . $this->pagination->total_rows . ' entries' ?></div>
                    <div class="col-md-6">
...
<div style="margin-top: 40px;" class="modal fade request-modal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body" id="request-form"></div>
        </div>
    </div>
</div>
<script>
