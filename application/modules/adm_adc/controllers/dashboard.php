...
class Dashboard extends CI_Controller
{
    ...
    function show()
    {
        ...
        $error_notis = $this->db
            ->limit($this->pagination->per_page, $offset)
            ->get()
            ->result_array();
        ...
        $content = $this->load->view(
            'admin/content/report_violation.php',
            array('dulieu' => $error_notis, 'start_count' => $offset + 1, 'current_type' => $type),
            true
        );
    ...
    private function do_search()
    {
        ...
        if ($referer) {
            ...
            elseif (strpos($referer, '/show/brower') !== false) $current_type = 'brower';  // Thêm check cho brower
        }
    ...
    function charts()
    {
        ...
        $content = $this->load->view('admin/content/violation_charts.php', $data, true);
        $this->load->view('admin/index', ['content' => $content]);
    }
    ...
    function contact_list($offset = 0) { 
        ...
        // Pagination
        $this->load->library('pagination');
        $config['base_url'] = base_url('admin1/dashboard/contact');
        ...
        $content = $this->load->view('admin/content/contact_listd', $data, true);
        $this->load->view('admin/index', ['content' => $content]);
    }
