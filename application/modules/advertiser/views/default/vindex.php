      ...
      <div class="d-flex align-items-center justify-content-between">
        ...
        <div class="nav_u_profil me-4 pe-1">
          <div class="dropdown m-auto col-3 mx-3 d-flex d-row">
            ...
            <a class="nav-link dropdown-toggle fs-6" id="dropdownUser1" role="button" data-bs-toggle="dropdown" aria-expanded="false">
              <img src="<?= $advertiser->avatar_url ?>" width="30" height="30" class="rounded-circle">
            </a>
