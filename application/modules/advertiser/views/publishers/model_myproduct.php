    ...
    <div name="white" class="p-3 shadow bg-body border rounded d-flex box-offers-items">
        ...
        <div class="box-offers-container">
            <div class="box-offers-detail">
                <div class="box-offers-ticons" style="max-width: 400px; flex-wrap: wrap;">
                ...
                <a style="display: block;width:400px" class="box-offers-links" data-bs-toggle="modal" data-bs-target="#exampleModal<?= $offer->id ?>" data-toggle="tooltip" data-placement="top" title="<?= $offer->title ?>">
                    <?= $offer->title ?>
                </a>
            ...
            <div class="sc-TFwJa eSDKjj d-flex flex-column">
                <div class="col-sm-2 center">
                    <a href="<?= base_url('v2/product') . '/' . $offer->id ?>"><button class="btn_prv_link btn_prv_link_2">
                            ...
                            <span class="btn_prv_link_2_child2 color_blue_nice">Edit</span>
                        </button></a>
                </div>
                <br>
