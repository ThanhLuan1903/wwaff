                    ...
                    <div class="sc-bRBYWo eVigII">
                        ...
                        <div class="sc-hzDkRC ioyCcs">
                            <div style="width: 385px;">
                                <form class="sc-kpOJdX kFPdwr" needs-validation>
                                    <input type="text" name="ref_pub_token" hidden value="<?= isset($_GET['ref']) ? $_GET['ref'] : null ?>">
                                    <div class="sc-hSdWYo drEhZp">
                                        ...
                                        <div class="row col-12 mx-auto">
                                            <div class="col-6 form-check mx-auto">
                                                <input class="form-check-input" type="radio" name="type_account" value="Personal" id="flexRadioDefault1">
                                        ...
                                        <div class="row col-12 mx-auto">
                                            <div class="col-6 form-check mx-auto">
                                                <input class="form-check-input" type="radio" name="user_setting[has_affiliate_program]" value="1" id="radio">
                                                <label class="form-check-label" for="radio">Yes, I already have</label>
                                            </div>
                                            <div class="col-6 form-check mx-auto">
                                                <input class="form-check-input" type="radio" name="user_setting[has_affiliate_program]" value="0" id="radio2" checked>
                                        ...
                                        <div class="sc-ckVGcZ xzcRZ">
                                            <div class="sc-kAzzGY jIpyka" height="52px">
                                                ...
                                                <input type="text" class="jxLAT click_btn_login" style="border:1px solid #CACFD3;border-radius:8px;height: 40px;" name="username" value="">
                                            </div>
                                        </div>
                                        <div class="sc-ckVGcZ xzcRZ">
                                            <div class="sc-kAzzGY jIpyka" height="52px">
                                        ...
                                        <p class="sc-cvbbAY hMwApc">Password must contain: 8 or up to 30 characters with
                                            at least one uppercase, at least one of the allowed special characters listed:
                                            _-!@*.$%?&amp;#/|\&gt;^{}[]():;
                                        </p>
                                        <div class="sc-ckVGcZ xzcRZ">
                                            <div class="sc-kAzzGY jIpyka" height="52px">
                                        ...
                                        <div class="sc-gipzik fusulQ">
                                            ...
                                            <div class="sc-gipzik fusulQ">
                                                <div class="sc-kAzzGY jIpyka" height="52px">
                                                    ...
                                                    <input maxlength="255 " style="border:1px solid #CACFD3;border-radius:8px;height: 40px;" type="text" class="jxLAT click_btn_login"
                                                        name="social_network">
                                                </div>
                                            </div>
                                            <div class="sc-gipzik fusulQ">
                                                <div class="sc-kAzzGY jIpyka" height="52px">
                                                    ...
                                                    <input maxlength="255" style="border:1px solid #CACFD3;border-radius:8px;height: 40px;" type="text" class="jxLAT" name="website" value="">
                                                </div>
                                                <div class="sc-gipzik fusulQ">
                                                    <div class="sc-kAzzGY jIpyka" height="52px">
                                                        <p>Link Avatar*(Please use image with 3x4 size)</p>
                                                        <input maxlength="255" type="text" class="jxLAT" style="border:1px solid #CACFD3;border-radius:8px;height: 40px;"
                                                            placeholder="Real avatars will get a higher chance of accepting accounts." name="avatar_url" value="">
                                                    </div>
                                                    <div class="sc-ckVGcZ xzcRZ">
                                                        <div class="sc-kAzzGY jIpyka" height="52px">
                                                            <p>Product Geo *</p>
                                                            <select class="selectpicker" multiple name="product_geo_ids[]"
                                                                aria-label="size 3 select example">
                                                                <?php foreach ($countries as $ct) { ?>
                                                                    <option value="<?php echo $ct->id ?>">
                                                                        <?php echo $ct->country ?></option>
                                                                <?php } ?>
                                                            </select>
                                                        </div>
                                                    </div>
                                                    <div class="sc-gipzik fusulQ">
                                                        <p class="sc-jlyJG bqJkQa"><span>Please choose your traffic type:</span><span class="sc-csuQGl bDzGcN"></span></p>
                                                        <div>
                                                            <?php foreach ($traffic_types as $type): ?>
                                                                <?php $idRandom = rand(10, 100) ?>
                                                                <div class="_2yRUtwQzTcJQHKHRzGIAfL _1zMi2ue1d1ggkuAFpIUpBi">
                                                                    <input class="" type="checkbox" name="traffic_source_id[]" value="<?= $type->id ?>" id="<?= $type->id ?>">
                                                                    <label class="_7H-rw2-gbQmIWhoWOkS93 css-7c2d00" for="<?= $type->id ?>">
                                                                        <span class="_7H-rw2-gbQmIWhoWOkS93 css-7c2d00"><?= $type->content ?></span>
                                                                    </label>
                                                                </div>
                                                            <?php endforeach; ?>
                                                        </div>
                                                    ...
                                                    <div class="sc-gipzik fusulQ">
                                                        <p class="sc-jlyJG bqJkQa"><span>Please choose product category:</span><span class="sc-csuQGl bDzGcN"></span></p>
                                                        <div>
                                                            <select name="product_categories[]" class="selectpicker" data-placeholder="Product Category" multiple>
                                                    ...
                                                    <div class="sc-gipzik fusulQ">
                                                        <p class="sc-jlyJG bqJkQa"><span>About your business:</span><span class="sc-csuQGl bDzGcN">*</span></p>
                                                        <textarea name="how_to_get_traffic" placeholder="Please introduce your business, fill more than 200 characters"
                                                            type="text" class="css-sd33">
                                                        </textarea>
                                                    </div>
                                                    <div class="sc-eHgmQL kLECzY">
                                                        <div class="_2yRUtwQzTcJQHKHRzGIAfL _1zMi2ue1d1ggkuAFpIUpBi">
                                                            <input class="" type="checkbox" name="user_setting[agree_with_term_1]" id="agree_with_term_1" value="1">
                                                            <label class="_7H-rw2-gbQmIWhoWOkS93 css-7c2d00" for="agree_with_term_1">
                                                                <span class="_7H-rw2-gbQmIWhoWOkS93 css-7c2d00">
                                                                    <span>I agree with
                                                                        <a class="sc-jWBwVP bBsnzv" target="_blank" href="<?php // echo base_url('v2/terms');
                                                        ...
                                                        <div class="_2yRUtwQzTcJQHKHRzGIAfL _1zMi2ue1d1ggkuAFpIUpBi css-l9drzq">
                                                            <input class="" type="checkbox" value="1" name="user_setting[agree_with_term_2]" id="agree_with_term_2">
                                                            <label class="_7H-rw2-gbQmIWhoWOkS93 css-7c2d00" for="agree_with_term_2">
                                                                <span class="_7H-rw2-gbQmIWhoWOkS93 css-7c2d00">I here by consent and allow the use of my and/or my companys
                                                                    information, including sharing with a third party, to assess, detect, prevent or otherwise enable
                                                                    detection and prevention of malicious, invalid or unlawful activity and/or general fraud prevention.
                                                                </span>
                                                            </label>
                                                        </div>
                                                    </div>
                                                    <div class="sc-dxgOiQ jaHTXm">
                                                        <button type="submit" class="K3TX2EnGEDIGIEiEIo_0X _3-Xcfgk4YnBeM0kgvmZfs_ btn_signup">
