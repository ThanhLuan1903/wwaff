...
<div class="row cpv_postback_info mt-3 pt-3">
   <div class="fomziX">
      ...
      <div class="box-pb-infomation">
         <div class="box-pb-inf_title" data-bs-toggle="collapse" data-bs-target="#collap_infopb<?= $offer->id ?>">
         ...
         <div class="opostback_infomation collapse" id="collap_infopb<?= $offer->id ?>">
            ...
            <div class="sc-iGPElx jhcKlU">
               <table class="table table-striped table-hover">
                  ...
                  <tbody>
                     <tr>
                        <td>{uagent}</td>
                        <td>UserAgent of user browser</td>
                     </tr>
                     <tr>
                        <td>{ip}</td>
                     ...
                     <tr>
                        <td>{ref_id}</td>
                        <td>Used to send clickid value via a postback</td>
                     </tr>
                     <tr>
                        <td>{os_id}</td>
                        <td>Additional parameter for tracking URL</td>
                     </tr>
                     <tr>
                        <td>{ext1}</td>
                        <td>Additional parameter for tracking URL</td>
                     ...
                     <tr>
                        <td>{transactionid}</td>
                        <td>Conversion identificator of advertiser</td>
                     </tr>
                     <tr>
                        <td>{date}</td>
                        <td>Date and time of conversion committing in format Y-m-d H:i:s</td>
                     </tr>
                     <tr>
                        <td>{click_date}</td>
                        <td>Date and time of click committing in format Y-m-d H:i:s</td>
                     </tr>
                     <tr>
                        <td>{offerid}</td>
                        <td>Offer identificator in the System</td>
                     </tr>
                     <tr>
                        <td>{offer_name}</td>
                        <td>Offer title in the System</td>
                     </tr>
                     <tr>
                        <td>{status}</td>
                        <td>Conversion status, available values:</td>
                     </tr>
                     <tr>
                        <td>{sum}</td>
                     ...
                     <tr>
                        <td>{time}</td>
                        <td>Time of conversion committing in format H:i:s</td>
                     </tr>
                     <tr>
                        <td>{date_only}</td>
                        <td>Date of conversion committing in format Y-m-d</td>
                     </tr>
                     <tr>
                        <td>{rand}</td>
                     ...
                     <tr>
                        <td>{timestamp}</td>
                        <td>unix timestamp of conversion creation</td>
                     </tr>
                     <tr>
                        <td>{fbclid}</td>
                        <td>Facebook click ID</td>
                     </tr>
                     <tr>
                        <td>{order_sum}</td>
                        <td>Used to send conversion's price</td>
                     </tr>
                     <tr>
                        <td>{order_currency}</td>
                        <td>Used to send conversion's currency</td>
                     </tr>
                  </tbody>
               </table>
            </div>
